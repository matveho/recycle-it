...
const wasteDisposalMap: Record<string, string> = {
    "Aluminium foil": "Garbage - Dispose in regular trash.",
    "Battery": "Hazardous Waste - Take it to a battery disposal center.",
    "Aluminium blister pack": "Garbage - Dispose in regular trash.",
    "Carded blister pack": "Garbage - Dispose in regular trash.",
    "Other plastic bottle": "Recycle - Empty and rinse before recycling.",
    "Clear plastic bottle": "Recycle - Empty and rinse before recycling.",
    "Glass bottle": "Recycle - Place in glass recycling bin.",
    "Plastic bottle cap": "Garbage - Unless assembled to the bottle(recyclable).",
    "Metal bottle cap": "Garbage - Unless assembled to the bottle(recyclable).",
    "Broken glass": "Garbage - Wrap in newspaper before disposal.",
    "Food Can": "Recycle - Empty and rinse before recycling.",
    "Aerosol": "Recycle - Throw it in the blue bin unless hazardous content.",
    "Drink can": "Recycle - Empty and rinse before recycling.",
    ...
    "Corrugated carton": "Recycle - Flatten and place in paper recycling bin.",
    "Meal carton": "Recycle - Empty and rinse before recycling.",
    "Pizza box": "Recycle - Clean and or stained with grease may be recycled.",
    "Paper cup": "Garbage - Dispose in regular trash.",
    "Disposable plastic cup": "Garbage - Dispose in regular trash.",
    "Foam cup": "Garbage - Styrofoam is not recyclable.",
    "Glass cup": "Garbage - Broken glass must be wrapped in newspaper before disposal.",
    "Other plastic cup": "Garbage - Dispose in regular trash.",
    "Food waste": "Compost - Dispose in organic waste bin.",
    "Glass jar": "Recycle - Empty and rinse before recycling.",
    "Plastic lid": "Recycle - Clean and rinse before recycling.",
    "Metal lid": "Recycle - Clean and rinse before recycling.",
    ...
    "Other plastic wrapper": "Garbage - Dispose in regular trash bin.",
    "Single-use carrier bag": "Recycle - Take to plastic bag recycling center.",
    "Polypropylene bag": "Recycle - Place in recycling.",
    "Crisp packet": "Garbage - Not recyclable.",
    "Spread tub": "Recycle - Empty and rinse before recycling.",
